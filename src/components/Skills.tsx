...
//     return (
//         <div id="skills" className="w-full py-2 pb-34 px-4 bg-background dark:bg-foreground">
...
import angularIcon from '../assets/icons/angularjs-original.svg';
...
import postmanIcon from '../assets/icons/getpostman-icon.svg';
import dockerIcon from '../assets/icons/docker-icon.svg';
import kanbanIcon from '../assets/icons/atlassian_jira-icon.svg';
...
const Skills = () => {
    ...
    const tools: Tool[] = [
        ...
        { name: 'AI Tools', icon: <Sparkles className="w-5 h-5" />, isComponent: true },
        { name: 'SCRUM', icon: <Users className="w-5 h-5" />, isComponent: true },
                                    ...
                                    {tools.map((tool, index) => (
                                        <div key={index} className="flex items-center gap-2">
                                            {tool.isComponent ? (
                                                ...
                                                <img
                                                    src={typeof tool.icon === 'string' ? tool.icon : ''}
                                                    alt={tool.name}
                                                    className="w-5 h-5"
                                                />
                                            )}
